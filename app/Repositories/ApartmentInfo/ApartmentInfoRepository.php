...
namespace App\Repositories\ApartmentInfo;

use Illuminate\Database\Eloquent\Model;
use App\Models\ApartmentInfo;

class ApartmentInfoRepository implements ApartmentInfoRepositoryInterface
{
    ...
    public function create(array $data)
    {
        ...
        return ApartmentInfo::create($data);
    }
