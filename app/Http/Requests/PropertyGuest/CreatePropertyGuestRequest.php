...
namespace App\Http\Requests\PropertyGuest;
...
class CreatePropertyGuestRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            //
            "maximum_guests"=>"required",
            "instructions"=>"required",
            "additional_details"=>"required",
            "apartment_id"=>"required|exists:apartment_infos,id|unique:property_guests,apartment_id"
